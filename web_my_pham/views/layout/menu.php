                                ...
                                <div class="main-menu">
                                    ...
                                    <nav class="desktop-menu">
                                        <ul>
                                            ...
                                            <li><a href="<?= BASE_URL . '?act=all-san-pham'?>">Sản phẩm </a>
                                                <!-- <ul class="dropdown">
                                                    <li><a href="blog-left-sidebar.html">Mỹ phẩm Makeup</a></li>
                                                    <li><a href="blog-left-sidebar.html">Mỹ phẩm dưỡng da</a></li>
                                                </ul> -->
                                            </li>
                        ...
                        <div class="col-lg-4">
                            <div class="header-right d-flex align-items-center justify-content-xl-between justify-content-lg-end">
                                ...
                                <div class="header-configure-area">
                                    ...
                                    <?php if (isset($_SESSION['user_client'])) { ?>
                                        <li><a href="<?= BASE_URL?>">Tài khoản</a></li>
