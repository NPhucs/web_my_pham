                        ...
                        <div class="checkout-billing-details-wrap">
                            ...
                            <div class="billing-form-wrap">
                                    ...
                                    <div class="single-input-item">
                                        ...
                                        <input type="email" id="email_nguoi_nhan" name="email_nguoi_nhan" value="<?= $user['email']?>" placeholder="Email người nhận" required />
                                    </div>
                                    ...
                                    <div class="single-input-item">
                                        ...
                                        <input type="text" id="dia_chi_nguoi_nhan" name="dia_chi_nguoi_nhan" value="<?= $user['dia_chi']?>" placeholder="Địa chỉ người nhận" placeholder="Địa chỉ người nhận" required />
                                    </div>
                                ...
                                <div class="order-payment-method">
                                    <div class="single-payment-method show">
                                        ...
                                        <div class="payment-method-details" data-method="cash">
                                            <p>Khách hàng thanh toán sau khi nhận hàng thành công </p>
                                        </div>
                                    </div>
