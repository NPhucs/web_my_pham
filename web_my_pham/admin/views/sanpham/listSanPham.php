            ...
            <div class="card">
              <div class="card-header">
                <a href="<?= BASE_URL_ADMIN . '?act=form-them-san-pham' ?>">
                  <button class="btn btn-success">Thêm mỹ phẩm</button>
                </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        onerror="this.onerror=null; this.src='https://images.gofreedownload.net/cosmetics-handpainted-vector-49017.jpg'"
                        >
                    </td>
