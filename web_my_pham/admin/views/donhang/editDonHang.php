              ...
              <form action="<?= BASE_URL_ADMIN . '?act=sua-don-hang' ?>" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="sdt_nguoi_nhan" value="<?= $donHang['sdt_nguoi_nhan']?>" placeholder="Nhập số điện thoại người nhận">
                  ...
                  <div class="form-group">
                    <label >Địa chỉ</label>
                    <input type="text" class="form-control" name="dia_chi_nguoi_nhan" value="<?= $donHang['dia_chi_nguoi_nhan']?>" placeholder="Nhập ghi chú">
                  ...
                  <div class="form-group">
                    <label >Ghi chú</label>
                    <textarea name="ghi_chu" class="form-control" placeholder="Nhập ghi chú"><?= $donHang['ghi_chu']?></textarea>
                  </div>
                ...
                <select id="inputStatus" name="trang_thai_id" class="form-control custom-select">
                    <?php foreach($listTrangThaiDonHang as $trangThai) : ?>
                        <option 
                        <?php
                                // Nếu trạng thái lớn hơn id thì sẽ không back được về trước 
